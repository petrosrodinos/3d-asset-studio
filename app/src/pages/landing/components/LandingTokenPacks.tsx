...
export function LandingTokenPacks() {
  ...
  return (
    <section id="pricing" className="relative z-10 border-t border-border/60 bg-surface/20" aria-labelledby="token-packs-heading">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        <div className="max-w-2xl">
          <h2 id="token-packs-heading" className="mt-3 text-2xl font-bold tracking-tight text-slate-50 sm:text-3xl">
            {LANDING_PACKS_TITLE}
          </h2>
