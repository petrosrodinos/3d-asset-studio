  ...
  return (
    <div className="landing-mesh flex min-h-svh flex-col text-slate-200">
      ...
      <main className="relative flex flex-1 flex-col">
        ...
        <section className="relative z-10 mx-auto grid w-full max-w-6xl flex-1 items-center gap-12 px-4 py-12 sm:gap-16 sm:px-6 sm:py-16 lg:grid-cols-[1.05fr_0.95fr] lg:py-20">
          <div className="max-w-xl lg:max-w-none">
            <p
              className={cn(
                "landing-rise font-mono text-xs font-medium uppercase tracking-widest text-accent-light/90",
              )}
            >
              {LANDING_HERO_BADGE}
            </p>
            <h1 className="landing-rise landing-rise-delay-1 mt-4 font-sans text-3xl font-bold leading-[1.08] tracking-tight text-slate-50 sm:text-4xl sm:leading-[1.06] lg:text-[2.75rem]">
              {LANDING_HERO_TITLE}
            </h1>
            <p className="landing-rise landing-rise-delay-2 mt-5 text-sm leading-relaxed text-slate-400 sm:text-base sm:leading-relaxed">
              {LANDING_HERO_SUBTITLE}
            </p>
